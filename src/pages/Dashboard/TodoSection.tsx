import { Avatar, Card, Dropdown, Menu, Tag, Typography, Divider } from "antd";
    ...
    <div className="">
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[14px] font-semibold">To Do</h4>
        </div>
        <button className="bg-[#E7F0FF] text-[#2563EB] px-4 py-2 rounded-md flex items-center gap-2">
          <svg
            width="12"
            height="12"
            viewBox="0 0 12 12"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M6 0V12M12 6H0" stroke="#2563EB" />
          </svg>
          Add Task
        </button>
      </div>
          ...
          >
            <div className="flex-1">
              ...
              >
                ...
                <div>
                  <Text strong>Status:</Text> <Tag color="red">Not Started</Tag>
                </div>
                <div>
                  <Text type="secondary">Created on: 20/06/2023</Text>
                </div>
              </div>
            </div>
          </Card>
        </div>
        <Divider size="middle" className="w-full" />
        <div className="">
          <Card
            style={{ width: "100%", borderRadius: 8 }}
            className="flex gap-4 relative items-start"
